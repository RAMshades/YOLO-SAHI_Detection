...
![Procedure for SAS small-object identification and characterization. This work uses a two-fold detection and characterization approach that allows for less rigid classification and further analysis of objects in sonar data. ](methods_yolo_ddt.png)
